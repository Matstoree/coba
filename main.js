...
const connectionOptions = {
  ...
  // ❌ version: version,  <-- baris ini dihapus
...
async function connectionUpdate(update) {
  ...
  if (global.db.data == null) loadDatabase()
    ...
    if (connection == 'close') {
        console.log(chalk.yellow(`🚩ㅤConnection closed, please delete the folder sessions and rescan the pairing code`));
    }
}
